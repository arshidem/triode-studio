  ...
  const teamMembers = [
    {
      ...
      focus:
        "Scalable web applications, API integration, performance optimization",
      expertise: [
  ...
  const processSteps = [
    {
      ...
      description:
        "Requirement analysis and technical assessment, user research and project scope definition",
    },
    {
      step: "02",
      title: "Design & Architecture",
      description:
        "Wireframing and visual design, system architecture and database planning",
    },
    {
      step: "03",
      title: "Development & Implementation",
      description:
        "Frontend and backend development, design integration and asset optimization",
    },
    {
      step: "04",
      title: "Testing & Delivery",
      description:
        "Quality assurance and performance testing, deployment and post-launch support",
    },
  ];
                        ...
                        <div className={styles.contactLinks}>
                          ...
                          <div className={styles.socialIcons}>
                                ...
                                >
                                  <g>
                                    <g>
                                      <path
                                        fill="#f2f2f2"
                                        d="M38.51,19.25c0,5.29-2.17,10.11-5.66,13.6-3.49,3.49-8.3,5.65-13.6,5.65-.38,0-.76-.01-1.13-.04C8.05,37.88,0,29.46,0,19.25c0-5.29,2.17-10.11,5.65-13.6C9.14,2.16,13.95,0,19.25,0s10.11,2.16,13.6,5.65c3.35,3.35,5.49,7.93,5.64,12.98.02.21.02.41.02.62Z"
                                      ></path>
                                      <path
                                        fill="#c6c6c6"
                                        d="M38.51,18.65v.6c0,5.29-2.17,10.11-5.66,13.6-3.49,3.49-8.3,5.65-13.6,5.65h-1.09s-.03-.03-.04-.04c-3.5-3.49-6.99-6.98-10.49-10.49-.35-.3-.57-.74-.57-1.24v-14.13c0-2.05,2.35-3.23,3.99-1.99l1.55,1.16,6.65,4.99,6.65-4.99,1.55-1.16c1.08-.81,2.44-.58,3.26.25,2.59,2.58,5.19,5.18,7.78,7.77l.02.02Z"
                                      ></path>
                                      <g>
                                        <path
                                          fill="#4285f4"
                                          d="M8.72,28.39h3.88v-9.42l-5.54-4.16v11.91c0,.92.75,1.66,1.66,1.66"
                                        ></path>
                                        <path
                                          fill="#34a853"
                                          d="M25.9,28.39h3.88c.92,0,1.66-.75,1.66-1.66v-11.91l-5.54,4.16"
                                        ></path>
                                        <path
                                          fill="#fbbc04"
                                          d="M25.9,11.77v7.2l5.54-4.16v-2.22c0-2.06-2.35-3.23-3.99-1.99"
                                        ></path>
                                        <path
                                          fill="#ea4335"
                                          d="M12.6,18.97v-7.2l6.65,4.99,6.65-4.99v7.2l-6.65,4.99"
                                        ></path>
                                        <path
                                          fill="#c5221f"
                                          d="M7.06,12.6v2.22l5.54,4.16v-7.2l-1.55-1.16c-1.65-1.23-3.99-.06-3.99,1.99"
                                        ></path>
                                      </g>
                                    </g>
                                  </g>
                            ...
                            {member.contact.mobile && (
                              <a
                                href={`tel:${member.contact.mobile}`}
                                className={styles.socialIcon}
                                title="Call"
                              >
                                <svg
                            ...
                            {member.contact.whatsapp && (
                              <a
                                href={`https://wa.me/${member.contact.whatsapp.replace(
                                  "+",
                                  ""
                            ...
                            {member.contact.behance && (
                              ...
                              >
                                ...
                                >
                                  ...
                                  <path
                                    fill="#fff"
                                    d="M57 63s6-2.23 6-10-5.14-11-12-11H28v44h23s13 0 13-13c0 0 0-10-7-10zM38 50h13s3 0 3 4c0 4.52-2 5-4 5H38zm12 28H38V67l12.59-.07S55 67 55 73c0 5-3.19 4.95-5 5zm34.77-25.12c-16.69 0-16.68 16.68-16.68 16.68S67.17 86 85 86c0 0 15 1.39 15-11h-8s.24 4.28-7 4.28c0 0-8 .79-8-7.28h23s2.34-19.12-15.23-19.12zM92 66H77s1.24-6.76 7.94-6.76S92 66 92 66zM75 44h19v6H75z"
                                  ></path>
                                </svg>
                              </a>
                            )}
                      ...
                      <motion.button
                        ...
                        onClick={() => {
                          const subject = encodeURIComponent(
                            `Project Inquiry - ${member.name}`
                          );
                          const body = encodeURIComponent(
                            `Hello ${member.name},\n\nI would like to discuss...`
                          );
                          window.open(
                            `https://mail.google.com/mail/?view=cm&fs=1&to=${member.contact.email}&su=${subject}&body=${body}`,
                            "_blank"
                          );
                        }}
                      >
    ...
    >
      ...
      >
        <div className={styles.headerContent}>
          ...
          <p className={styles.subtitle}>
            Digital Innovation Partners - Where technical excellence meets
            creative vision to deliver comprehensive digital solutions.
          </p>
          ...
          <div className={styles.storyGrid}>
            <div className={styles.storyText}>
              <p className={styles.storyDescription}>
                Triode Studio brings together complementary expertise in
                development and design to deliver comprehensive digital
                solutions. Our partnership combines technical excellence with
                creative vision to help businesses thrive in the digital
                landscape.
              </p>
              <p className={styles.storyDescription}>
                <strong>Why "Triode Studio"?</strong> Inspired by the triode's
                ability to amplify and control electronic signals, we amplify
                our clients' digital presence while ensuring precise control
                over user experience and functionality.
              </p>
            </div>
      ...
      >
        <div className={styles.ctaContent}>
          ...
          <p>
            Let's collaborate to bring your ideas to life with our combined
