  ...
  const services = [
    {
      ...
      title: "Web Design",
      shortDescription:
        "Modern, responsive interfaces crafted with attention to detail.",
      fullDescription:
        "We create visually stunning designs that engage users and drive conversions. Our web design process focuses on creating intuitive, beautiful interfaces that reflect your brand identity while ensuring optimal user experience across all devices.",
      features: [
      ...
      process: [
        ...
        {
          step: "Wireframing",
          description: "Create structural layout and flow",
        },
        { step: "Design", description: "Develop visual design and branding" },
        {
          step: "Testing",
          description: "User testing and feedback implementation",
        },
        {
          step: "Delivery",
          description: "Final assets and style guide handoff",
        },
      ],
    ...
    },
    {
      ...
      fullDescription:
        "We build scalable, secure, and performant web applications tailored to your business needs. Our development process ensures clean, maintainable code with robust architecture and seamless user experiences.",
      features: [
    ...
    },
    {
      ...
      title: "UI/UX Design",
      shortDescription:
        "Beautiful and usable interfaces designed with user experience at the core.",
      fullDescription:
        "We blend aesthetics with functionality seamlessly, creating interfaces that users love to interact with. Our design process is research-driven, ensuring every decision improves user satisfaction and achieves business goals.",
      features: [
      ...
      process: [
        ...
        {
          step: "Wireframing",
          description: "Information architecture and layout",
        },
        {
          step: "Prototyping",
        ...
        {
          step: "Handoff",
          description: "Developer handoff with specifications",
        },
      ],
    ...
    },
    {
      ...
      shortDescription:
        "Custom online store solutions with secure payment integration.",
      fullDescription:
        "Boost your sales with optimized shopping experiences. We build e-commerce platforms that convert visitors into customers with seamless shopping journeys, secure transactions, and powerful management tools.",
      features: [
      ...
      process: [
        {
          step: "Store Setup",
          description: "Platform configuration and setup",
        },
        {
          step: "Product Integration",
          description: "Catalog and inventory setup",
        },
    ...
    },
    {
      ...
      fullDescription:
        "Drive organic traffic and grow your online presence with our comprehensive SEO strategies. We combine technical expertise with content optimization to help you rank higher and attract qualified visitors.",
      features: [
      ...
      process: [
        ...
        {
          step: "Reporting",
          description: "Regular progress reports and insights",
        },
      ],
